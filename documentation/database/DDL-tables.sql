...
CREATE TABLE Packages (
    ...
    SpecialistId INT NOT NULL, -- FK to CoreIdentity (deferred)
    PackageTypeId INT NOT NULL, -- FK to PackageTypes (deferred)
...
CREATE TABLE PackageTypes (
    PackageTypeId SERIAL PRIMARY KEY,
    HumanReadableId VARCHAR(20) NULL,
    RecordStatusId INT NOT NULL, -- FK to RecordStatuses (deferred)
...
CREATE TABLE PackageFormEvents (
    PackageFormEventId SERIAL PRIMARY KEY,
    HumanReadableId VARCHAR(20) NULL,
    RecordStatusId INT NOT NULL, -- FK to RecordStatuses (deferred)
    PackageId INT NOT NULL, -- FK to Packages (deferred)
    FormTypeId INT NOT NULL, -- FK to FormTypes (deferred)
    EventType VARCHAR(20) NOT NULL, -- 'Sent' or 'Received'
...
CREATE TABLE AuditLogs (
    ...
    ChangedData JSONB NULL, -- Stores the changed row as JSON
    CreatedDate TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
    CreatedBy INT NOT NULL, -- FK to CoreIdentity (deferred)
    CreatedIpAddress VARCHAR(45) NOT NULL,
    ModifiedDate TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
