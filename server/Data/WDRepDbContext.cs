...
namespace WDRepApp.Server.Data
{
    ...
    public DbSet<WDRepApp.Server.Entities.MenuItem> MenuItems { get; set; }
    public DbSet<WDRepApp.Server.Entities.MenuItemType> MenuItemTypes { get; set; }
    public DbSet<WDRepApp.Entities.DefaultItem> DefaultItems { get; set; }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<WDRepApp.Entities.DefaultItem>().ToTable("defaultitems");
    }
    }
}
